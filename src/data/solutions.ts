...
export const solutions: Solution[] = [
  {
    ...
    downloadSize: '145 MB',
    downloadUrl: 'https://github.com/openviglet/dumont/releases/download/v2026.1.20/dumont-connector.jar',
  ...
  },
  {
    ...
    downloadSize: '309 MB',
    downloadUrl: 'https://github.com/openviglet/turing/releases/download/v2026.1.18/viglet-turing.jar',
